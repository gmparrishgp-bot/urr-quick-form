(async()=>{
  try{
    const files=['urr-r20/chunk00.txt?v=21', 'urr-r20/chunk01.txt?v=21', 'urr-r20/chunk02.txt?v=21', 'urr-r20/chunk03.txt?v=21', 'urr-r20/chunk04.txt?v=21', 'urr-r20/chunk05.txt?v=21', 'urr-r20/chunk06.txt?v=21'];
    ...
    (0,eval)(pieces.join("\n"));
    const domain=await fetch('urr-r21/domain.js?v=21',{cache:"no-store"});
    if(!domain.ok)throw new Error('Could not load R21 handwriting correction layer');
